...
function drawEffectSize(value)
{
    ...
    {    
        sideBar.append("text")
                ...
                .attr("y", canvasHeight/2 - significanceTestResultStep + effectSizeHeight/2 - yAxisTickTextOffset)
...
{        
    ...
    for(var i=0; i<levels.length; i++)
    {
        ...
        sideBar.append("rect")
                .attr("x", currentX)
                .attr("y", significanceTestResultOffsetTop - 3*significanceTestResultStep - tabHeight)
                .attr("width", tabWidth)
        ...
        sideBar.append("text")
                ...
                .attr("y", significanceTestResultOffsetTop - 3*significanceTestResultStep - tabHeight/2 + yAxisTickTextOffset)
                .attr("text-anchor", "middle")
    ...
    sideBar.append("rect")
                    .attr("x", 0)
                    .attr("y", significanceTestResultOffsetTop - 3*significanceTestResultStep)
                    .attr("height", 7*significanceTestResultStep)
