...
function displayToolTips()
{
    ...
    var variablePanelBorder = canvas.append("rect")
                                    ...
                                    .attr("width", variableNameHolderWidth - variableTypeSelectionButtonWidth + variableNameHolderPadding/2)
                                    .attr("height", variableNames.length * (variableNameHolderHeight + variableNameHolderPadding) - variableNameHolderPadding/2)
                                    .attr("rx", "5px")
                                    .attr("ry", "5px")
                                    .attr("fill","none")
                                    .attr("stroke", "#3957F1")
