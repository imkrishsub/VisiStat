...
{        
    ...
    for(var i=0; i<levels.length; i++)
    {
        ...
        sideBar.append("rect")
                .attr("x", currentX)
                .attr("y", significanceTestResultOffsetTop - 2.5*significanceTestResultStep - tabHeight)
                .attr("width", tabWidth)
        ...
        sideBar.append("text")
                ...
                .attr("y", significanceTestResultOffsetTop - 2.5*significanceTestResultStep - tabHeight/2 + yAxisTickTextOffset)
                .attr("text-anchor", "middle")
    ...
    sideBar.append("rect")
                    .attr("x", 0)
                    .attr("y", significanceTestResultOffsetTop - 2.5*significanceTestResultStep)
                    .attr("height", 6*significanceTestResultStep)
