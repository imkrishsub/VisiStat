...
function drawScales(cx, cy)
{
    ...
    if(1)
    {
        ...
        console.log(format.log(means[means.length - 1] - means[0]);
        if(testResults["CI"][1] - dec2(means[means.length -1] - means[0]) != dec2(means[means.length -1] - means[0]) - testResults["CI"][0])   
        {
